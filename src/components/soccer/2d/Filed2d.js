...
export default class Field2D extends Component {
    ...
    displayTShirts = () => {
        ...
        homeGroup.selectAll('image')
            ...
            homeGroup.on('click', (playerData, i, j) => this.props.onPlayerClick(playerData));
        ...
        awayGroup.selectAll('image')
            ...
            awayGroup.on('click', (playerData, i, j) => this.props.onPlayerClick(playerData));
    ...
    render() {
        let field = <img id="SSUI-Field2D-FieldTexture"
                width={this.props.field.width} height={this.props.field.height}
